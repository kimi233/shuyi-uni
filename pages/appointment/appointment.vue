	...
	<view class="show">
		...
		<view class="mid">
			...
			<view class="midone">
				...
				<view >
					<view class="s1">预约时间：2017-11-08 <image style="width: 30rpx; height: 30rpx;" src="../../static/images/位置.png"></image>
			...
			<view class="midone">
				...
				<view >
					...
					<view class="s7">
						...
						<view class="s8">
							<navigator url="../borrow/face_to_face">
			...
			<view class="midone">
					...
					<view class="s9">
						<navigator url="confirm">
							<button class="btn4"><view class="wz">确认收货</view></button>
						</navigator>
					</view>
				</view>
				<view >
					...
					<view class="s7">
						...
						<view class="s8">
							<navigator url="logistics">
								<button class="btn3"><view class="wz">查看物流</view></button>
							</navigator>
						</view>
					</view>
		...
		<view class="bt">
			<button style="background-color: #00BFFF;" >刷新</button>
		</view>
	</view>
</template>
